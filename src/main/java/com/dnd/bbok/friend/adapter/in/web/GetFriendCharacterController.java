...
public class GetFriendCharacterController {
  ...
  public ResponseEntity<DataResponse<GetBbokCharacterGroupResponse>> getBbokCharacter() {
    GetBbokCharacterGroupResponse characters = getIconQuery.getCharacterIconUrl();
